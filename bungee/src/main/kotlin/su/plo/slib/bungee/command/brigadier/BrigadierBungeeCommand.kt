...
import su.plo.slib.bungee.command.BungeeCommandManager.BrigadierContext

class BrigadierBungeeCommand(
    ...
    private val dispatcher = CommandDispatcher<BrigadierContext>()

    init {
        @Suppress("UNCHECKED_CAST")
        dispatcher.register(command as LiteralArgumentBuilder<BrigadierContext>)
    }

    override fun execute(sender: CommandSender, arguments: Array<out String>) {
        val context = BrigadierContext(commandManager.getCommandSource(sender))
