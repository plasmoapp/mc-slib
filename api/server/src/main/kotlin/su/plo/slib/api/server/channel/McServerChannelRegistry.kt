...
/**
 * Registry of custom channel keys for NeoForge.
 *
 * NeoForge channels can only be registered on specific loader events,
 ...
 * Then slib registers them on NeoForge, so then they can be used inside of [McServerChannelManager].
 *
